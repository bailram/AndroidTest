...
public class DetailMeal implements Parcelable
{
    ...
    public final static Parcelable.Creator<DetailMeal> CREATOR = new Creator<DetailMeal>() {


        @SuppressWarnings({
            "unchecked"
        })
        public DetailMeal createFromParcel(Parcel in) {
            return new DetailMeal(in);
        }

        public DetailMeal[] newArray(int size) {
            return (new DetailMeal[size]);
        }
